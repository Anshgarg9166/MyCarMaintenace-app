...
fun changeVehicleTypeImage(context: Context, vehicleType: String, resize: Boolean): Drawable {
    return try {
        when (vehicleType.lowercase()) {
            "car" -> AppCompatResources.getDrawable(context, R.drawable.generic_car)!!
            "motorcycle" -> AppCompatResources.getDrawable(context, R.drawable.generic_motorbike)!!
            "bus" -> {
                if (resize)
            ...
            "truck" -> AppCompatResources.getDrawable(context, R.drawable.generic_lorry)!!
            else -> AppCompatResources.getDrawable(context, R.drawable.generic_car)!!
        }
    } catch (e: Exception) {
        AppCompatResources.getDrawable(context, R.drawable.generic_car)!!
    }
}